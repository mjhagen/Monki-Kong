...
const unsigned char palette_sp[]={
  0x31, 0x02, 0x21, 0x27, // blues
  0x31, 0x16, 0x36, 0x30, // reds
  0x31, 0x19, 0x29, 0x16, // greens
  0x31, 0x26, 0x31, 0x30  // black and yellow
};

const unsigned char palette_bg[]={
  0x31, 0x20, 0x10, 0x00, // black and grays
  0x31, 0x35, 0x25, 0x15, // black and pinks
  0x31, 0x00, 0x00, 0x00  // black
};
